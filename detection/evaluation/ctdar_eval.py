...
Modified by Muhammad Umer
Outputs a fancy_grid table for results
"""
...
reg_gt_path = os.path.join(ROOT_DIR, "test")
reg_gt_path_archival = os.path.join(ROOT_DIR, "test")
reg_gt_path_modern = os.path.join(ROOT_DIR, "test")
str_gt_path_1 = os.path.join(ROOT_DIR, "test")
str_gt_path_2 = os.path.join(ROOT_DIR, "test")
str_gt_path_archival = os.path.join(ROOT_DIR, "test")
str_gt_path_modern = os.path.join(ROOT_DIR, "test")
...
def calc_table_score(result_path):
    ...
    try:
        ...
        print(
            "Error: Zero devision error found, (Possible that no adjacency relations were found), please check the input file."
        )
        return {"wF1": 0}
