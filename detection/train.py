...
def parse_args():
    ...
    parser.add_argument(
        "--no-validate",
        action="store_true",
        help="Disables validation during training.",
    )
    ...
    parser.add_argument(
        ...
        'be overwritten is a list, itz should be like key="[a,b]" or key=a,b '
    ...
    parser.add_argument(
        ...
        default="none",
        help="Type of job launcher.",
    )
    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument(
        "--auto-scale-lr",
        action="store_true",
        help="Enable automatic scaling of Learning Rate.",
    )
